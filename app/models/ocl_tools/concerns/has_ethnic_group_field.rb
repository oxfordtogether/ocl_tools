      ...
      class_methods do
        def has_ethnic_group_field(field_name)
          better_options_field field_name do
            ...
            option :english_welsh_scottish_northern_irish_british, "English/Welsh/Scottish/Northern Irish/British"
            option :irish, "Irish"
            ...
            option :any_other_mixed_multiple_ethnic_background, "Any other Mixed/Multiple ethnic background"
            ...
            option :any_other_black_african_caribbean_background, "Any other Black/African/Caribbean background"
            option :arab, "Arab"
