...
class _class extends _application_controller.default {
  ...
  search(event) {
    ...
    this.stimulate("AutocompleteReflex#perform", this.paramsValue, this.queryTarget.value);
  }
...
_defineProperty(_class, "targets", ["query", "value", "dropdown", "params", "searchIcon", "searchingIcon"]);
