...
class _class extends _stimulus.Controller {
  ...
  renderCal() {
    ...
    this.yearLabelTarget.innerText = this.year; // days
  ...
  formatDateAsLong(d) {
    return (0, _format.default)(d, "E do MMM, yyyy");
  }
...
_defineProperty(_class, "targets", ["overlay", "dayOverlay", "monthOverlay", "yearOverlay", "monthLabel", "yearLabel", "month", "year", "blankDay", "day", "input", "yearInput", "monthInput", "dayInput"]);